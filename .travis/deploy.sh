...
rsync -r --delete -e "ssh -i $TRAVIS_BUILD_DIR/.travis/ssh_key -o StrictHostKeyChecking=no" $TRAVIS_BUILD_DIR/src travis@$DEPLOY_HOST_IP:$DEPLOY_TARGET_DIR/$deploy_env
